...
The safety domain provides core functionality for safety-related operations in the Pyics calendar management system.

## Architecture

- **Load Order**: 90
- **Priority**: 5
- **Dependencies**: registry, routing
...
```python
from pyics.core.safety import create_entity, get_domain_metadata
